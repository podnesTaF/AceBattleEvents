...
export const getParticipantIndividualRaceTicket = (
...
<html lang="en" xml:lang="en">
  ...
  <body>
    <div class="container">
      <img
        src="https://storage.googleapis.com/abe_cloud_storage/website%2Fticket-top.svg"
        alt="template"
        class="image"
      />
        ...
        <div class="desc-container footer">
          <div class="wrapper">
            ...
            <div>
              ...
              <p class="value">Yeroskipou 8210,<br />Cyprus, Paphos</p>
            </div>
          </div>
          <img
            src="https://api.qrserver.com/v1/create-qr-code/?size=140x140&margin=0&bgcolor=ff1744&color=ffffff&data=${
