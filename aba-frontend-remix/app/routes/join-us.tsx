...
const JoinUs = () => {
  ...
  const onSubmit = async (dto: JoinFormValues) => {
    ...
    if (dto.image) {
      ...
      const media = await Api().media.addMedia(formData);
      if (media) {
        image = media;
      }
    }
              ...
              <div className="w-full flex gap-6 items-center justify-center mb-6 h-[100px] md:h-[150px]">
                ...
                {step !== 10 ? (
                  ...
                  <div className="flex flex-col items-center justify-center gap-6">
                    ...
                    <h4 className="font-semibold text-sm md:text-xl text-center max-w-sm">
              ...
              <FormProvider {...form}>
                ...
                >
                  ...
                  {step === 8 && (
                    <SlideLayout
                      fadeIn={step === 8}
                      question="We are pleadly ask you to upload your photo. It will appear in your profile."
                    >
                  ...
                  {step === 10 && (
                    <Fade in={step === 10} easing={"ease-in-out"}>
                    ...
                    {step < 10 ? (
                      ...
                      >
                        <div>
                          <button
                            type={"button"}
                            className="bg-[#1E1C1F] text-white hover:text-gray-300 text-lg sm:text-xl font-semibold p-3 disabled:cursor-not-allowed rounded-l-md shadow-md"
                            onClick={handlePrev}
                            disabled={step === 1}
                          >
                            Back
                          ...
                          {step === 9 ? (
                            <FormButton
                              ...
                              className="rounded-l-none rounded-r-md w-auto px-6 py-3 text-lg sm:text-xl font-semibold bg-green-400 text-white hover:text-gray-100 disabled:opacity-50 disabled:cursor-not-allowed shadow-md"
                            />
                          ) : (
                            <button
                              disabled={
