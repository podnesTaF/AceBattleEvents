...
const ClubInfo: React.FC<Props> = ({ club, finishedRaces }) => {
  return (
    <section className="bg-[#1E1C1F] w-full py-8 md:py-16">
      <div className="max-w-6xl px-6 mx-auto sm:mx-6 lg:mx-auto w-full flex flex-col sm:flex-row justify-between gap-6 items-center">
        <img
          src={
            club.logo?.mediaUrl ||
        ...
        />
        <div className="flex flex-col md:flex-row w-1/2 md:w-2/3 justify-between gap-5">
