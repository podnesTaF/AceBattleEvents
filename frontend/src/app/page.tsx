...
export default function Home() {
  return (
    <>
      <header className="w-full flex justify-center items-center h-96 h-calc-screen bg-[url('/main-intro-sm.jpg')] md:bg-[url('/main-intro.jpg')] bg-fixed bg-cover bg-no-repeat bg-top relative flex-col ">
