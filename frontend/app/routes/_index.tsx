  ...
  return (
    <main className="w-full">
      {data.announcedEvents.length && (
        <AnnonceStripe eventPreview={data.announcedEvents[0]} />
      )}
      ...
      <section className="py-6 relative">
        <div className="flex items-center flex-col gqp-2 lg:gap-4">
          ...
          />
          <h3 className="w-full text-xl sm:text-2xl lg:text-4xl font-semibold text-[#333] text-center  max-w-2xl 2xl:max-w-3xl mb-2">
      ...
      <section className="max-w-7xl xl:mx-auto mx-2 mt-4 xl:mt-8">
        <h2 className="font-bold text-3xl lg:text-4xl mb-4 lg:mb-6">
          Announcements
        </h2>
          ...
          >
            {data.newsPreviewsData?.newsPreviews.map((news, i) => (
              <SwiperSlide key={news.id}>
                <NewsCard variant="dark" item={news} />
              </SwiperSlide>
            ))}
          </Swiper>
      ...
      <RankingSection topRunners={data.topRunners} />
