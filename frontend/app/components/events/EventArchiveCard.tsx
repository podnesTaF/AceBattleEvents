...
export const EventArchiveCard = ({ event }: EventArchiveCardProps) => {
  ...
  return (
    <div className="max-w-6xl 2xl:max-w-7xl xl:mx-auto bg-white shadow-lg">
        ...
        <div className="relative flex flex-col justify-between py-5 px-4 pl-8 lg:pl-12 xl:py-8 w-full md:w-1/2 xl:w-2/5">
          ...
          <div>
            ...
            <Button
              ...
              color="error"
              variant="contained"
              className="btn-clip w-full py-1 lg:py-3 xl:py-4 rounded-none border-none"
            >
