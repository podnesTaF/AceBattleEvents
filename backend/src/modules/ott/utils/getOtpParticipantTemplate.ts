...
export const getOtpParticipantTemplate = ({
  otp,
  event,
}: {
  otp: string;
    ...
    <div class="email-container">
      ...
      <div class="main-container">
        ...
        <div class="title-text mb-4">
          You are about to become a participant of Ace Battle Mile !
        </div>
        <div class="main-text">
          We well received your registration for the ${event.title} !.<br />
          Your OTP for email confimation is: <strong>${otp}</strong>.<br />
